(function(angular, factory) {
    ...
    angular.module('ngTable').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('ng-table/filters/date.html', '<input type="date" name="{{name}}" ng-disabled="$filterRow.disabled" ng-model="params.filter()[name]" class="input-filter form-control" style="width: 117px; placeholder="{{getFilterPlaceholderValue(filter, name)}}"/> ');
